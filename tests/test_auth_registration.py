...
class RegistrationTestCase(unittest.TestCase):   
    ...
    def test_user_registered(self):
        ...
        res = self.client().post('/bookameal/api/v1/auth/register/', data=json.dumps(test_data),content_type='application/json')
    ...
    def test_user_registered_missing_credentials(self):
        ...
        res = self.client().post('/bookameal/api/v1/auth/register/', data=test_data,content_type='application/json')
